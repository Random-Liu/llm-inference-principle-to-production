...
As models reach trillions of parameters, this dense computation approach hits physical limits. [Mixture of Experts (MoE)](./part1_principles.md#section-7-mixture-of-experts-sparse-activation) solves this by activating only a fraction of parameters per token (e.g., 2 out of 256 experts). This sparse activation property unlocks a new strategy: **Expert Parallelism (EP)**.
