...
**一、 它要解决什么问题？**
在极长上下文场景下，核心瓶颈不再仅仅是模型权重，而是**呈线性或二次方增长的 KV Cache 和注意力计算量**。
...
> [!NOTE]
> **TODO: Ring Attention 的具体实现**
> 关于 Ring Attention 的具体计算过程（如分步交叉计算）以及如何结合 Online Softmax 保持数学等价性，我们将在后续章节中详细展开。
